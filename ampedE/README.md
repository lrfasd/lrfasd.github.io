...
> 
## 功能介绍
>支持通过修改附带的ini文件，实现批量从预设的kar、dat、repkar、skin、hskin、hhskin、omd、ssoa中全自动提取文件，解包cache系列kar及skin、hskin、hhskin文件时额外执行UnDataPack和CheckSkin，可选保存为zip、jar，可选在密码匹配失败后猜测密码，支持定义多套配置方案灵活切换。
> 
## 性能测试
