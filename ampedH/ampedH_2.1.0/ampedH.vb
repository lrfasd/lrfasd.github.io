...
Class ampedH
    ...
    Private NotifyMenu As Forms.ContextMenu
    ...
    Private Sub LoadControl()
        ...
        NotifyMenu = New Forms.ContextMenu()
    ...
    Private Sub ReadConfig()
        ...
        PreviewSize = Reader.ReadFloat("Preview", "Size", 0.25)
        PreviewTopmost = (Reader.ReadInteger("Preview", "Topmost", 1) > 0)
    ...
    Private Sub LoadNotifyMenu()
        ...
        NotifyMenu.MenuItems.Add(CloseMenuItem)
        ...
        NotifyMenu.MenuItems.Add(HideMenuItem)
        ...
        NotifyMenu.MenuItems.Add(AboutMenuItem)
        ...
        NotifyMenu.MenuItems.Add(ExitMenuItem)
    End Sub
    ...
    Private Sub RefreshInfo()
        ...
        For i As Integer = 0 To StackPanel.Children.Count - 1
            ...
            ToolTip.Width = CType(IIf(Me.IsAero AndAlso (Not TextBlock.Preview Is Nothing AndAlso Not TextBlock.Preview.IsVisible), ((Infos(i).Rect.Right - Infos(i).Rect.Left) * PreviewSize), 0), Double)
            ToolTip.Height = CType(IIf(Me.IsAero AndAlso (Not TextBlock.Preview Is Nothing AndAlso Not TextBlock.Preview.IsVisible), ((Infos(i).Rect.Bottom - Infos(i).Rect.Top) * PreviewSize), 0), Double)
            ToolTip.Tag = i
        Next
        If IsChanged Then
    ...
    Private Sub AddList(ByVal Hwnd As IntPtr)
        ...
        TextBlock.Preview = New PreviewWindow(Infos(UBound(Infos)).Handle, PreviewSize, PreviewTopmost)
        ...
        If Infos(i).Thumbnail = IntPtr.Zero Then
            ...
            If Not PresentationSource Is Nothing Then
                Try
                    ...
                    DwmUpdateThumbnailProperties(Infos(i).Thumbnail, New DwmThumbnailProperties(DwmThumbnailPropertie.DWM_TNP_RectDestination + DwmThumbnailPropertie.DWM_TNP_RectSource + DwmThumbnailPropertie.DWM_TNP_Opacity + DwmThumbnailPropertie.DWM_TNP_Visible + DwmThumbnailPropertie.DWM_TNP_SourceClientAreaOnly, New RECT(0, 0, ToolTip.Width, ToolTip.Height), New RECT(Position.X, Position.Y, Position.X + (Infos(i).Rect.Right - Infos(i).Rect.Left), Position.Y + Infos(i).Rect.Bottom - Infos(i).Rect.Top), 255, True, False))
