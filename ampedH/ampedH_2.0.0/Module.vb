...
Module UserModule
    ...
    <DllImport("user32.dll")> _
    Public Function GetClientRect(ByVal Hwnd As IntPtr, ByRef lpRect As Rects) As Integer
    End Function
    <DllImport("user32.dll")> _
    Public Function GetWindowRect(ByVal Hwnd As IntPtr, ByRef lpRect As Rects) As Integer
    End Function
    <DllImport("user32.dll")> _
    ...
    Public Structure DwmThumbnailProperties
        ...
        Public rcDestination As Rects
        Public rcSource As Rects
        Public opacity As Byte
        Public fVisible As Boolean
        Public fSourceClientAreaOnly As Boolean

        Public Sub New(ByVal dwFlags As Integer, ByVal rcDestination As Rects, ByVal rcSource As Rects, ByVal opacity As Byte, ByVal fVisible As Boolean, ByVal fSourceClientAreaOnly As Boolean)
            Me.dwFlags = dwFlags
    ...
    Public Function GetClientToWindow(ByVal Hwnd As IntPtr) As Point
        Dim WindowRect As Rects
        GetWindowRect(Hwnd, WindowRect)
        Dim ClientRect As Rects
    ...
    End Function
    Public Function GetGlowEffect(ByVal FontSize As Double) As Effect
